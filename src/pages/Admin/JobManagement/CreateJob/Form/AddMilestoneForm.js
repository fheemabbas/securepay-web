        ...
        <div className='createMile' >
            <HookForm
                ...
                {(formMethod) => {
                    return (
                        <div className="form">
                            <Label title='Add Milestone'></Label>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(AddMilestoneForm));
